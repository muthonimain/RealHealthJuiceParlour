...
const STYLE_BY_ID: Record<string, { color: string; lightColor: string; textColor: string }> = {
  ...
  'protein-shakes': { color: 'bg-sky-600', lightColor: 'bg-sky-50', textColor: 'text-sky-700' },
  'wellness-shots': { color: 'bg-purple-600', lightColor: 'bg-purple-50', textColor: 'text-purple-700' },
  'fresh-therapy-juices': { color: 'bg-orange-500', lightColor: 'bg-orange-50', textColor: 'text-orange-700' },
  ...
  'healing-greens-vegetables': { color: 'bg-emerald-600', lightColor: 'bg-emerald-50', textColor: 'text-emerald-700' },
  ...
  'real-health-coffee': { color: 'bg-stone-600', lightColor: 'bg-stone-50', textColor: 'text-stone-700' },
  'healthy-snacks': { color: 'bg-orange-500', lightColor: 'bg-orange-50', textColor: 'text-orange-700' },
  'boosters-add-ons': { color: 'bg-lime-600', lightColor: 'bg-lime-50', textColor: 'text-lime-700' },
